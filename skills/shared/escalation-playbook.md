...
| `fallback_chain` | HexStrike alternate tool in chain |

## API

```
POST /api/v1/hybrid/escalation/suggest
GET  /api/v1/hybrid/dispatch/suggest?engagement_id=&run_id=
GET  /api/v1/hybrid/graph/siblings?host=
```
