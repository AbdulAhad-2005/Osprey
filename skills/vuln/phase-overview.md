...
**Prioritise by exposure × value:** high-value roles (remote access, mail, admin,
API, business apps) and internet-facing app hosts first. Use `platform_graph_query`
/ `platform_context` rather than scanning every asset equally.
