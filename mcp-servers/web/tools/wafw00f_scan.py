...
Harvested: HexStrike `wafw00f_scan` -> `/api/tools/wafw00f`.
Category: web
"""
...
def run(target: str = '', additional_args: str = '', use_recovery: bool = True, use_cache: bool = True, exec_timeout: int = 300) -> dict[str, Any]:
