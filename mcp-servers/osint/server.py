"""
FastMCP server — `osint` capability domain (passive people/identity recon).

Keyless passive-OSINT tools: username, email, phone, social, document, and
website-seed contact harvesting. Mirrors the recon server's harvest loop.
"""
