...
TOOL_NAME = "docker_bench_security_scan"
CATEGORY = "cloud"
...
def run(checks: str = '', exclude: str = '', output_file: str = '/tmp/docker-bench-results.json', additional_args: str = '', use_recovery: bool = True, use_cache: bool = True, exec_timeout: int = 300) -> dict[str, Any]:
    params = {"checks": checks, "exclude": exclude, "output_file": output_file, "additional_args": additional_args}
