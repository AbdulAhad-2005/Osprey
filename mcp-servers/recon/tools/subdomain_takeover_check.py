...
_CLI_CONTAINER = "/home/mcpuser/mcp-servers/recon/tools/_subdomain_takeover_cli.py"
_CLI_FALLBACK = str(Path(__file__).resolve().with_name("_subdomain_takeover_cli.py"))
...
def build_command(**params: Any) -> str:
    ...
    return f"python3 {_cli_expr()} {shlex.quote(encoded)}"
